...
void tESP::tESPFunctions::Tick()
{
	...
	{*/
		...
		{*/
			...
			{
				std::wstring posX = L"X: " + std::to_wstring(pESP.LocalPlayerEntityInfo.Origin[0]);
				std::wstring posY = L"Y: " + std::to_wstring(pESP.LocalPlayerEntityInfo.Origin[2]);
				std::wstring posZ = L"Z: " + std::to_wstring(pESP.LocalPlayerEntityInfo.Origin[1]);
